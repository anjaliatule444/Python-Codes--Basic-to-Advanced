...
4. If we want to inherit very few parameters.(Create 1 variable as global variable)
'''
...
class Print_Parameters:
    ...
    def __init__(self,email,phone,age):
        self.email=email
        self.__phone=phone
        self._age=age
...
class Inherit_Print_Parameters(Print_Parameters):
    def __init__(self, email, phone, age):
        super().__init__(email, phone, age)
...
try:
    ...
    print_obj=Print_Parameters(Email,Phone,Age)
    ...
    inherited_print_obj=Inherit_Print_Parameters(Email,Phone,Age)
